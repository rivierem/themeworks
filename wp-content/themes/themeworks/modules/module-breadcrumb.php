...
if (is_page() && !is_front_page() || is_single() || is_category() || is_search() || is_tax() || is_archive()) {
	...
	if (is_tax()) {
		// $category = get_the_category();
		echo '<li><a href="#">'.single_term_title( '', true ).'</a></li>';
	}

	// if ( !is_single() && !is_page() && get_post_type() != 'post' && !is_404() ) {
 //      $post_type = get_post_type_object(get_post_type());
 //      $t_name = $post_type->labels->singular_name;
 //      echo '<li>'.$t_name . single_cat_title('', false).'</li>'; //ICI

 //    }
	// if (is_archive()) {
	// 	// $category = get_the_category();
	// 	echo '<li><a href="">'.single_cat_title( '', true ).'</a></li>';
	// }
...
//     elseif (is_tax()) { echo 'is_tax'; }
//     elseif (is_archive()) {echo 'is_archive';}
...
//       $post_type = get_post_type_object(get_post_type());
//       $t_name = $post_type->labels->singular_name;
//       echo $before .$t_name. $delimiter . single_cat_title('', false) . $after; //ICI
...
?>
<?php  ?>
<?php //if (function_exists('tw_breadcrumbs')) tw_breadcrumbs(); ?>
